...
urlpatterns = [
    ...
    path('comments/', CommentViewset.as_view({'get':'list_all'}), name='all_comments'), # get request to list all visible comments
    ...
    path('likes/', LikeViewset.as_view({'get': 'list_all'}), name='all_likes'), # get request to list all likes
