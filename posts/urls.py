...
urlpatterns = [
    ...
    path('comment/user/<int:user_pk>/', CommentViewset.as_view({'get':'retrieve_users'}), name='specific_user_comments'),
    ...
    path('likes/user/<int:user_pk>/', LikeViewset.as_view({'get': 'retrieve_users'}), name='specific_user_likes'),
]
